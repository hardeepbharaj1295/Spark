...
package com.o7services.spark.backup;
...
import com.o7services.spark.MainActivity;
...
import static com.o7services.spark.database.DatabaseCreation.DATABASE_NAME;
...
public class RemoteBackup {
    ...
    private HomeNavigationActivity activity;

    public RemoteBackup(HomeNavigationActivity activity) {
